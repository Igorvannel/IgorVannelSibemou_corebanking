...
ENTRYPOINT ["java", "-XX:+AlwaysActAsServerClassMachine", "-Djava.awt.headless=true", "-cp","/exploded:/exploded/lib/*:/external-info.json","com.banking.IgorVannelSibemou_corebanking.IgorVannelSibemouCorebankingApplication"]